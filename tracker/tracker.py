...
class TrackerService:
    ...
    def __init__(self, broker, topic_in, output_dir, model_path, classes_to_count, w=1920, h=1080, fps=30):
        ...
        self.video_writer = cv2.VideoWriter(os.path.join(output_dir,"object_counting_output.mp4"), 
...
class YoloTracker:
    ...
    def count(self, img):
        tracks = self.model.track(img, persist=True, show=False, classes=self.classes_to_count)
